        ...
        menu: 
            ...
            "\"C каких это пор вы стали выбирать себе задания, мисс Грейнджер?":
                ...
                if True:
                    ...
                    m "Что?! \"СУКИ\"?!"
                    her "Не \"суки\", сэр, а С.Ц.У.К.О. - Союз Целенаправленно и Упорно Кривду Осуждающих. Правда, с названием пока не решено..." #Цель
                ...
                menu: 
                    ...
                    "\"Хорошо, еще 15 очков. Рассказывай!":
                        ...
                        m "Мисс Грейнджер!"
                        her "Сэр?"
                        m "Так, по-вашему, вы зарабатываете 15 очков?"
                        ...
                        m "Еще немного, я окончательно разочаруюсь в вас и вы не получите вообще ни одного очка."
                        her "Просто не сбивайте меня, сэр. Хорошо?"
                        her "Ну вот... Одна девочка призналась мне, что ей нравится ходить без белья."
                        her "Когда она идет по лестнице и парни смотрят снизу, она чувствует... она возбуждается, сэр."
                        m "{size=-4}(О-о, это намного лучше...){/size}"
                        ...
                        m "{size=-4}(О, д-да-а... Представляю эту картину!){/size}"
                        $herView.hideshowQQ( "body_45.png", pos )
                        ...
                        m "{size=-4}(Да... Какая прилежная шлюха, продолжай!){/size}"
                        $herView.hideshowQQ( "body_29.png", pos )
                        ...
                        menu: 
                            ...
                            "\"Продолжай, будут тебе очки!\"":
                                ...
                                her "И еще, сэр, рассказывали как одна девушка дрочила одному преподавателю, а потом тут же пошла дрочить другому..."
                                ...
                                $herView.hideshowQQ( "body_34.png", pos )
                                her "Но вы же и так кончили, сэр. Но если вы хотите узнать..."
                                m "Что?! Ты опять вымогаешь очки?"
                                her "Всего 15 очков, сэр."
                                m "Ты зарываешься, девчонка!"
                                her "Простите, сэр, тогда я просто получу свои 35 очков и пойду."
                                menu: 
                                    "\"Иди прочь!\"":
                                    ...
                                    "\"Ладно. +15 очков, рассказывай. Но это в последний раз!\"":
                                        ...
                                        her "Конечно, я все понимаю. В общем, если парень угадывает чья это..."
                                        her "Гхм... в общем, угадывает чье это, то девчонка должна дать ему так, как он захочет."
                                        her "А если "
                                        m "Вот дерьмо!"
                                        her "Профессор, по-момему у вас опять встает. Если вы хотите, продолжить, то всего 15 оч..."
                                        m "Нет!!! На сегодня все!"
