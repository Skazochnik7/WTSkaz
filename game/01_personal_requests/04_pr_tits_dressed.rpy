        ...
        if whoring>=12: # Если уже играл с ее голыми сиськами
            ...
            menu:
                "Заголяйтесь, мисс!":
                    ...
                    her "Сэр, а обязательно быть таким вульгарным?"
                    m "Вы будете меня учить, мисс Грейнджер или все-таки зарабатывать очки?"
                    her ".........."
                    current_payout+=
                ...
                "На сегодня все, девочка.":
                    ...
                    if whoring<18: # Если не готова к сексу
                        ...
                        her "Аргх! Сэр... как вы можете!... Я!..."
                        m "Ладно-ладно, мисс Грейнджер, я просто пошутил насчет раздвинутых ножек. Никто на вас не покушается."
                        if not end.IsEnding(const_ENDING_STRONG_GIRL):
                            her "Гррх!... Заплатите мне и я пойду!"
                            mad=+30
                            jump new_request_04_finish
