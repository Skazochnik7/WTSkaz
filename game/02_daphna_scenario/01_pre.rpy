...
label daphna_pre_01: #LV.1 (Whoring = 0 - 2)
    ...
    $snape("~02// Понимаешь, мой друг, все не так просто.// Эти девки… Они уверены, что ты,… ну, директор, не в курсе наших маленьких шалостей.")
    $hero("И?")
    ...
    $snape("~04// Да, но если они узнают о твоем интересе, они могут не захотеть больше этого делать.// #(Надеюсь он проглотит эту хрень)// #На самом деле я не собираюсь присылать ему шлюх -//"
