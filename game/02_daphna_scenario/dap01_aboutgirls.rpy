...
label dap_request_01_complete:
    ...
    if IsRunNumber(1):
        ...
        $daphne("~55 00 1 pou// Ну, в общем-то, нет. Я потому и выбрала ее, что она довольно популярна, несмотря ни на что.//"
        ...
        $hero("И тем не менее, я готов вас простимулировать.// Надеюсь, это поможет вам в следующий раз.")
