...
#    "EVENT_08_02"
    ...
    her "Профессор Дамблдор, Я здесь, чтобы поговорить с вами, как  президент \"С.У.К.О\"..."
    m "............."
...
#    "EVENT_08_03"
    ...
    m "Неужели..?"
    her "Вчера было еще одно заседание общества \"С.У.К.О\", и--"
    m "Ох, опять..."
    m "А есть хоть один парень в вашем маленьком обществе су...?"
    ...
    her "Я официально к вам обращаюсь, как президент \"С.У.К.О\"..."
...
label event_09: #Second visit from Hermione. Says she sent a letter to the Minestry. 
    ...
    $herView.hideshowQQ( "body_04.png", pos )
    her "Я создала \"Союз Учеников Кривду Осуждающих\" в нашей школе! Мы защищаем права мужчин..."
    g4 "Да, я уже слышал от вас ..."
    g4 "Это типично для вас винить во всем-"
    stop music fadeout 1.0
    m "Стоп, ты сказала права {size=+5}МУЖЧИН{/size}?"
    ...
    menu:
        ...
        "{size=-3}\"Это общество - самая глупая идея, которую я когда-либо слышал.\"{/size}":
            $herView.hideshowQQ( "body_07.png", pos )
...
label event_12: # Hermione complains that she did failed a test. (EVENING EVENT!)
    ...
    her "Ну, мне лучше пойти. У нас еще одно собрание \"С.У.К.О\" сегодня."
...
label event_14: # Hermione comes after her breakdown (when she failed the test). She is asking for tutoring. Tutoring unlocked.
    ...
    $herView.hideshowQQ( "body_07.png", pos )
    her "Но это не все..."
    her "В обществе \"С.У.К.О\" мы исследуем нашу систему образования более детально..."
