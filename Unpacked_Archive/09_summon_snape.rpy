...
label special_date_with_snape: #TAKES PLACE AFTER FIRST VISIT FROM HERMIONE.
    ...
    m "Что насчет мальчишки Поттере?"
    sna_06 "Мальчишка Поттер? Ха! Да кто он такой !?"
    ...
    if jerk_off_session:
        ...
        sna_09 "Все джины такие...удивительные негилисты?"
...
label special_date_with_snape_02: #TAKES PLACE AFTER SECOND VISIT FROM HERMIONE. (Where she says that she sent letter to the ministry.)
    ...
    m "Она также имеет превосходную репутацию."
    sna_06 "О, да!"
    ...
    sna_11 "......................?"
    m "Что если мы отнимем ее у нее"
    ...
    sna_07 "Даже \"Slytherin\" не так догоняет в этом году..."
    sna_16 "........................"
    ...
    menu:
        ...
        "{size=-3}\"Конечно же \"Гриффиндор\" потеряет кубок в этом году!\"{/size}" if not d_flag_02:
            ...
            sna_20 "Есть несколько \"Слизеринских\"девушек, которые готовы полученить допольнительные очки для своего дома."
            sna_19 "О, это сработает великолепно!"
            sna_18 "Ты Гений!"
            m "Да, я Джин-гений. Но каковы шансы ..."
            if d_flag_01 and d_flag_02 and d_flag_03:
                pass
            else:
                jump fuck_off
    ...
    sna_07 "Да..."
    sna_06 "Теперь найлей мне еще вина."
