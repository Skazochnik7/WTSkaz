...
label special_date_with_snape: #TAKES PLACE AFTER FIRST VISIT FROM HERMIONE.
    ...
    menu:
        "\"Да! Та еще сука!\"":
            ...
            sna_02 "Эта девка..."
        "\"Кого ты ненавидишь?\"":
            sna_01 "И ты еще спрашивешь?"
            sna_01 "Эту девку Гермиону, конечно!"
        "\"Она настолько плоха?\"":
            sna_01 "Хуже!"
    ...
    if jerk_off_session:
        ...
        sna_09 "Все Джинны такие... удивительные нигилисты?"
    ...
    sna_07 "У меня занятия завтра рано, так что давай закругляться." #собираться ночью."
...
label special_date_with_snape_02: #TAKES PLACE AFTER SECOND VISIT FROM HERMIONE. (Where she says that she sent letter to the ministry.)
    ...
    sna_02 "Да, черт ее возьми. Эта девчонка трудоголик. Я признаю это за ней."
    ...
    menu:
        ...
        "{size=-3}\"Конечно же \"Гриффиндор\" потеряет кубок в этом году!\"{/size}" if not d_flag_02:
            $ d_flag_02 = True
            sna_01 "Просто начать вычитать очки у них без как либо причины?"
